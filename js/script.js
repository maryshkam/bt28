...
//  */
// const numbers = [{name: "Bob", age: 25}, {name: "Bobik", age: 5}, {name: "Vasya", age: 15}, {name: "Alibaba", age: 42}];
...
// }
// console.log("--------");
// numbers.forEach(function callback(element, index, arr) {
//   console.log(element);
// });

// const checkElement = (element,index, arr) => {
//     console.log(element.name);
//     console.log(index);
//     console.log(arr);
//   }

//   numbers.forEach(checkElement);
